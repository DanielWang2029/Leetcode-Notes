...
3) ***It's not very expensive to check whether a value is target or not# 1. Binary Search
...
My own implementation of Binary Indexed Tree could be found [here](https://github.com/DanielWang2029/Python-and-Algorithms/blob/master/Data_Structures_and_Algorithms/Binary_Index_Tree.py).
